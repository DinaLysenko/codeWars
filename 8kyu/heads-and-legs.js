...
function animals(heads, legs) {
    ...
    let chiken = heads - cow
    return Number.isInteger(cow) && Number.isInteger(chiken) && chiken >= 0 && cow >= 0 ? [chiken, cow] : "No solutions"
}


console.log('animals: ', animals(72, 200))
console.log('animals: ', animals(72, 201))
